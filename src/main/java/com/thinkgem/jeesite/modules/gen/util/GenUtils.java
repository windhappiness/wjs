...
//			}
//			// 部门
//			else if (StringUtils.startsWithIgnoreCase(column.getName(), "office_code")){
//				column.setJavaType(Office.class.getName());
//				column.setJavaField(column.getJavaField().replaceAll("Code", ".code|name"));
//				column.setShowType("officeselect");
//			}
//			// 区域
//			else if (StringUtils.startsWithIgnoreCase(column.getName(), "area_code")){
